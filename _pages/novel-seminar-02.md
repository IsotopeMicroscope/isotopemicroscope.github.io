...
第２回目も引き続き、ノーベル化学賞「元素分配の研究」です。

今回は、第１回で中心テーマとなった軽元素の分配をまとめ、希土類元素などの重元素にフォーカスしていきます。

前回講師の吉崎昴博士に加え、クライオDAC試料分析のパイオニアである田川翔博士と共に、物質中の元素の振る舞いを解明する、という研究でノーベル賞を獲得するにはどうすれば良いか議論します。
